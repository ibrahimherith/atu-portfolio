...
const SkillsPage = () => {
    return ( 
        <>
            <Navbar />
            <section
                className="min-h-screen pt-20 px-4 md:px-8 space-y-8"
            >
                <div>
                ...
                <div className="justify-items-center">
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-3 lg:grid-rows-2 gap-10">
                        ...
                        <div className="block w-full px-2 py-2">
                            ...
                            <p className="">4 years Experience sswtryhrsteychtikfuysctrfe6ytfikjx</p>
                        </div>
                        ...
                        <div className="block px-2 py-2">
                            ...
                            <p className="">4 years Experience srtgeruztuzyiu;iduydcxgtuiupouxxxyuiiiycttd</p>
                        </div> 
